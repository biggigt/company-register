		...
		<div class="ui two column centered grid">
			<div class="column">
				<form class="ui form" action="{{route('registry.include')}}" method = "post">
			        @csrf
			        <div class="field">
			          <label for="registry_name">Реестр:</label>
			          <select name = "registry_name" id = "registry_name" class="ui search dropdown" required>
		                ...
		                @foreach($registry_types as $registry)
		                  <option value="{{ $registry->id }}">{{ $registry->registryType }}</option>
		                @endforeach
			          </select>
			        </div>
			        <div class="field">
			          ...
			          <select name = "company_name" id = "company_name" class="ui search dropdown" required>
		                ...
		                @foreach($companies as $company)
		                  <option value="{{ $company->id }}">{{$company->business_type}} "{{ $company->name }}"</option>
		                @endforeach
			          </select>
			        </div>
			        <div class="field">
