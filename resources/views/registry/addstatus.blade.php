...
@section('title','Добавить статус для предприятия')
@section('content')
        ...
        <div class="ui two column centered grid">
            <div class="column">
                <form class="ui form" action="{{route('registry.addstatus')}}" method = "post">
                    @csrf
                    <div class="field">
                        <label for="reg_hsc_id">Записи в реестре:</label>
                        <select name = "reg_hsc_id" id = "reg_hsc_id" class="ui search dropdown" required>
