      ...
      <table class="ui celled table">
        ...
        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr class = "text-center">
            ...
            <td><?php echo e($company->business_types->code); ?> "<?php echo e($company->name); ?>"</td>
            <td><?php echo e($company->regnumber); ?></td>
            <td><?php echo e($company->facility_types->facility_type_name); ?></td>
            <td><?php echo e($company->subject_actings->name); ?></td>
            <td><?php echo e($company->subject_owners->name); ?></td>
